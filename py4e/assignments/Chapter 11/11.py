'''
https://www.py4e.com/tools/python-data/?PHPSESSID=962c0fc3c05c3c639d95442d0b113488

Welcome Roshan Kumar from Using Python to Access Web Data
...
* Actual data: http://py4e-data.dr-chuck.net/regex_sum_125903.txt (There are 79 values and the sum ends with 470)
...
Sum:            (ends with 470)         Submit Assignment
Python code:
...
file = open('regex_sum_125903.txt', 'r')
